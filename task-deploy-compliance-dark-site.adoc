...
summary: Complete unos pasos para implementar Cloud Data Sense en un host de un sitio local que no tiene acceso a Internet. Este tipo de instalación es perfecta para sus sitios seguros. 
---
= Implemente Cloud Data Sense en sus instalaciones sin acceso a Internet
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
+
Tanto el conector BlueXP como el sensor de datos requerirán actualizaciones manuales periódicas para habilitar nuevas funciones. Puede ver la versión de Data Sense en la parte inferior de las páginas de la interfaz de usuario de Data Sense. Compruebe la link:whats-new.html["Notas de la versión de Cloud Data Sense"] para ver las nuevas funciones de cada versión y si desea esas funciones. A continuación, puede seguir los pasos a. <<Actualice el software de detección de datos,Actualice su software de detección de datos>>.
